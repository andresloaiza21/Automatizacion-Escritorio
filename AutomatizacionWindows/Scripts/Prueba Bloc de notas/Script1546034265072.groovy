...
driver.findElement(By.name('Edición')).click()

driver.findElement(By.name('Hora y fecha')).click()

driver.findElement(By.name('Formato')).click()

driver.findElement(By.name('Fuente...')).click()
